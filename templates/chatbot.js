...
(function() {
    ...
    // Step 1: Define the HTML and CSS for the chatbot UI.
    // NOTICE THE <script> TAG IS REMOVED FROM THIS STRING.
    const chatbotUiHtml = `
    ...
    // Step 2: Inject the chatbot UI into the host page.
    document.body.insertAdjacentHTML('beforeend', chatbotUiHtml);

    // Step 3: Now that the HTML elements are on the page, run the script to make them interactive.
    // This is the logic that was previously inside the <script> tag.
    
    // --- IMPORTANT CONFIGURATION ---
    const API_BASE_URL = 'http://127.0.0.1:5001';

    // Get references to the newly added DOM elements
    ...
    // Load the 'marked' library for Markdown rendering
